...
현재 **S2까지 구현했고 배포해 사용 중**입니다. 로그인, 대화 저장과 스트리밍, 기억 등록·정정·삭제와 Context 반영이 동작합니다.

S3까지 끝냈고 연속성 평가 E01~E10을 1회 통과했습니다. 다만 실사용에서 **새 대화가 사용자를 모르고 이전 대화를 찾지 못하는 것**을 확인했습니다. 대화에서 기억을 자동 저장하는 경로와 여러 대화에 걸친 검색이 아직 없습니다.

다음은 S4입니다. 제품 방향은 `docs/06`, 대화·주제·지도 설계는 `docs/05`에 있습니다.
