...
다음은 S3입니다. 대화 목록과 주제(Topic) 구조, 작업 연속성을 붙입니다. 설계는 `docs/05`에 있습니다.
...
| S3 맥락의 연속성 | 진행 예정 · 대화 목록 → 주제 → 작업 연속성 |
| S4 이후 | 자동 주제 발견, 관계도, 임베딩 지도 |

개발 Task와 완료 기준은 로드맵과 `docs/05`를 따릅니다.
